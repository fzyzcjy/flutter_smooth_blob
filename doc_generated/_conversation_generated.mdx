...
Remark: This works well in my flutter_smooth experiments, and contributes to the final ~60FPS benchmark result.
...
*I will add tests and fix CI and refine code after some code review - since review may request changing the code :)*
...
Note: I deliberately do not add any tests yet, because the test are trivial and I want to listen to some feedbacks first (e.g. changing the PR). After feedbacks I will definitely add tests, no worries :)
...
*I will add tests and refine code and enhance strategy etc after some code review - since review may request changing the code :)*

Remark: This works well in my flutter_smooth experiments, and contributes nontrivially to the final ~60FPS benchmark result. But it benefits Flutter even without flutter_smooth as well!
...
*I will add tests and refine code etc (for example the unneeded memory copies) after some code review - since review may request changing the code :)*
*This works pretty well in flutter_smooth, see https://github.com/fzyzcjy/engine/blob/flutter-smooth/shell/common/animator.cc for full code.*
...
*I will add tests and refine code etc (for example the unneeded memory copies) after some code review - since review may request changing the code :)*
*This works pretty well in flutter_smooth, see https://github.com/fzyzcjy/engine/blob/flutter-smooth for full code.*
...
### Fix bug that`timeDilation` is not reset, causing subsequent test errors
...
*I will add tests and refine code etc (for example the unneeded memory copies) after some code review - since review may request changing the code :)*
*This works pretty well in flutter_smooth, see [fzyzcjy/engine@flutter-smooth](https://github.com/fzyzcjy/engine/blob/flutter-smooth) for full code.*
